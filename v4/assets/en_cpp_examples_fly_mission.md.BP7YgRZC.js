import{_ as n,o as a,c as p,ag as e}from"./chunks/framework.D1p_5hVZ.js";const i="/v4/assets/fly_mission_example_qgc.mPp45O0s.jpg",h=JSON.parse('{"title":"Example: Fly Mission","description":"","frontmatter":{"github_branch":"v4"},"headers":[],"relativePath":"en/cpp/examples/fly_mission.md","filePath":"en/cpp/examples/fly_mission.md"}'),l={name:"en/cpp/examples/fly_mission.md"};function t(o,s,c,m,u,d){return a(),p("div",null,s[0]||(s[0]=[e('<h1 id="example-fly-mission" tabindex="-1">Example: Fly Mission <a class="header-anchor" href="#example-fly-mission" aria-label="Permalink to &quot;Example: Fly Mission&quot;">​</a></h1><p>The <a href="https://github.com/mavlink/MAVSDK/tree/main/cpp/examples/fly_mission" target="_blank" rel="noreferrer">Fly Mission</a> example shows how to create, upload, and run, pause, and restart missions using the SDK.</p><p><img src="'+i+`" alt="Fly Mission QGC Screenshot"></p><h2 id="run_example" tabindex="-1">Running the Example <a class="header-anchor" href="#run_example" aria-label="Permalink to &quot;Running the Example {#run_example}&quot;">​</a></h2><p>The example is built and run in the normal way (<a href="./../examples/#trying_the_examples">as described here</a>).</p><p>The example terminal output should be similar to that shown below:</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>This is from a debug build of the SDK. A release build will omit the &quot;Debug&quot; messages.</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$ ./fly_mission udpin://0.0.0.0:14540</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Waiting to discover system...</span></span>
...
<span class="line"><span>Mission status update: 6 / 6</span></span>
<span class="line"><span>Disarmed, exiting.</span></span></code></pre></div><h2 id="how-it-works" tabindex="-1">How it works <a class="header-anchor" href="#how-it-works" aria-label="Permalink to &quot;How it works&quot;">​</a></h2><p>The operation of most of this code is discussed in the guide: <a href="./../guide/missions.html">Missions</a>.</p><h2 id="source_code" tabindex="-1">Source code <a class="header-anchor" href="#source_code" aria-label="Permalink to &quot;Source code {#source_code}&quot;">​</a></h2><ul><li><a href="https://github.com/mavlink/MAVSDK/blob/main/cpp/examples/fly_mission/CMakeLists.txt" target="_blank" rel="noreferrer">CMakeLists.txt</a></li><li><a href="https://github.com/mavlink/MAVSDK/blob/main/cpp/examples/fly_mission/fly_mission.cpp" target="_blank" rel="noreferrer">fly_mission.cpp</a></li></ul>`,13)]))}const _=n(l,[["render",t]]);export{h as __pageData,_ as default};
