import{_ as s,o as n,c as e,ag as p}from"./chunks/framework.BpToWd9i.js";const o="/main/assets/qgc_offboard_velocity.Dizz_O51.png",u=JSON.parse('{"title":"Example: Offboard Velocity","description":"","frontmatter":{"github_branch":"main"},"headers":[],"relativePath":"en/cpp/examples/offboard_velocity.md","filePath":"en/cpp/examples/offboard_velocity.md"}'),i={name:"en/cpp/examples/offboard_velocity.md"};function t(l,a,c,r,d,m){return n(),e("div",null,a[0]||(a[0]=[p('<h1 id="example-offboard-velocity" tabindex="-1">Example: Offboard Velocity <a class="header-anchor" href="#example-offboard-velocity" aria-label="Permalink to &quot;Example: Offboard Velocity&quot;">​</a></h1><p>This example shows how to how to control a vehicle in <em>Offboard mode</em> using velocity commands (in both the NED and body frames).</p><p><img src="'+o+`" alt="Offboard Mode - Velocity Control QGC Screenshot"></p><h2 id="run_example" tabindex="-1">Running the Example <a class="header-anchor" href="#run_example" aria-label="Permalink to &quot;Running the Example {#run_example}&quot;">​</a></h2><p>The example is built and run <a href="./../examples/#trying_the_examples">as described here</a> (the standard way).</p><p>The example terminal output should be similar to that shown below:</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>This is from a debug build of the SDK. A release build will omit the &quot;Debug&quot; messages.</p></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$ ./offboard udpin://0.0.0.0:14540</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Wait for system to connect via heartbeat</span></span>
...
<span class="line"><span>Landed</span></span></code></pre></div><h2 id="how-it-works" tabindex="-1">How it works <a class="header-anchor" href="#how-it-works" aria-label="Permalink to &quot;How it works&quot;">​</a></h2><p>The operation of most of this code is discussed in the guide: <a href="./../guide/offboard.html">Offboard Control</a>.</p><h2 id="source_code" tabindex="-1">Source code <a class="header-anchor" href="#source_code" aria-label="Permalink to &quot;Source code {#source_code}&quot;">​</a></h2><ul><li><a href="https://github.com/mavlink/MAVSDK/blob/main/cpp/examples/offboard/CMakeLists.txt" target="_blank" rel="noreferrer">CMakeLists.txt</a></li><li><a href="https://github.com/mavlink/MAVSDK/blob/main/cpp/examples/offboard/offboard.cpp" target="_blank" rel="noreferrer">offboard_velocity.cpp</a></li></ul>`,13)]))}const b=s(i,[["render",t]]);export{u as __pageData,b as default};
