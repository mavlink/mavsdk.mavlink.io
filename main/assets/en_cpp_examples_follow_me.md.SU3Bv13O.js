import{_ as s,c as n,al as a,o as l}from"./chunks/framework.BVh3rIuO.js";const i="/main/assets/follow_me_example_qgc.CEkbKa_s.jpg",m=JSON.parse('{"title":"Example: Follow Me Mode","description":"","frontmatter":{"github_branch":"main"},"headers":[],"relativePath":"en/cpp/examples/follow_me.md","filePath":"en/cpp/examples/follow_me.md"}'),o={name:"en/cpp/examples/follow_me.md"};function p(t,e,c,d,h,r){return l(),n("div",null,e[0]||(e[0]=[a('<h1 id="example-follow-me-mode" tabindex="-1">Example: Follow Me Mode <a class="header-anchor" href="#example-follow-me-mode" aria-label="Permalink to &quot;Example: Follow Me Mode&quot;">​</a></h1><p>This example demonstrates how to use the <a href="./../guide/follow_me.html">Follow Me</a> plugin. It shows how to send the drone both the current position of the target (<code>FollowMe::TargetLocation</code>) and the relative position at which it should follow (<code>FollowMe::Config</code>).</p><p><img src="'+i+`" alt="Follow Me QGC Screenshot"></p><blockquote><p><strong>Note</strong> A real application using this API will get the position information from the underlying operating system. The example uses a fake position source (<code>FakeLocationProvider</code>) to enable it to be run on computers that do not have position information. The <code>FakeLocationProvider</code> emulates the typical usage of common positioning APIs used in Android, Linux and iPhone.</p></blockquote><h2 id="run_example" tabindex="-1">Running the Example <a class="header-anchor" href="#run_example" aria-label="Permalink to &quot;Running the Example {#run_example}&quot;">​</a></h2><p>Special notes for this example:</p><ul><li>Before running this example you will need to install Boost libraries. For Linux this is done as shown below:<div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> apt-get</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> libboost-all-dev</span></span></code></pre></div></li><li>To use <em>QGroundControl</em> with this example you <strong>must</strong> ensure that <em>GSC Position Streaming</em> is disabled (otherwise QGC and the SDK will both send position updates and they will conflict). To do this use the latest <em>QGC Daily Build</em> and ensure that the <strong><a href="https://docs.qgroundcontrol.com/en/SettingsView/General.html" target="_blank" rel="noreferrer">Application Setting &gt; General</a> &gt; Miscellaneous &gt; Stream GCS Position</strong> is set to <em>Never</em>.</li></ul><p>Otherwise the example is built and run in the normal way (<a href="./../examples/#trying_the_examples">as described here</a>).</p><p>The example terminal output should be similar to that shown below:</p><blockquote><p><strong>Note</strong> This is from a debug build of the SDK. A release build will omit the &quot;Debug&quot; messages.</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$ ./follow_me udp://:14540</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[01:55:59|Info ] DronecodeSDK version: 0.2.8 (dronecode_sdk_impl.cpp:25)</span></span>
