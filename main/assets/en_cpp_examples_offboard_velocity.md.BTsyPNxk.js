import{_ as s,c as n,al as e,o as p}from"./chunks/framework.BVh3rIuO.js";const o="/main/assets/qgc_offboard_velocity.Dizz_O51.png",u=JSON.parse('{"title":"Example: Offboard Velocity","description":"","frontmatter":{"github_branch":"main"},"headers":[],"relativePath":"en/cpp/examples/offboard_velocity.md","filePath":"en/cpp/examples/offboard_velocity.md"}'),t={name:"en/cpp/examples/offboard_velocity.md"};function i(l,a,c,r,d,m){return p(),n("div",null,a[0]||(a[0]=[e('<h1 id="example-offboard-velocity" tabindex="-1">Example: Offboard Velocity <a class="header-anchor" href="#example-offboard-velocity" aria-label="Permalink to &quot;Example: Offboard Velocity&quot;">​</a></h1><p>This example shows how to how to control a vehicle in <em>Offboard mode</em> using velocity commands (in both the NED and body frames).</p><p><img src="'+o+`" alt="Offboard Mode - Velocity Control QGC Screenshot"></p><h2 id="run_example" tabindex="-1">Running the Example <a class="header-anchor" href="#run_example" aria-label="Permalink to &quot;Running the Example {#run_example}&quot;">​</a></h2><p>The example is built and run <a href="./../examples/#trying_the_examples">as described here</a> (the standard way).</p><p>The example terminal output should be similar to that shown below:</p><blockquote><p><strong>Note</strong> This is from a debug build of the SDK. A release build will omit the &quot;Debug&quot; messages.</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$ ./offboard udp://:14540</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Wait for system to connect via heartbeat</span></span>
